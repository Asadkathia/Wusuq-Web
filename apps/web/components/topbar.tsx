            ...
            <div className="absolute right-0 top-12 z-50 w-80 rounded-2xl border border-slate-200 bg-white shadow-xl">
              <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setBellOpen(false)}><X className="h-4 w-4 text-slate-400" /></button>
                </div>
              </div>
              ...
              <ul className="max-h-72 divide-y divide-slate-50 overflow-y-auto">
                {notifications.length === 0 ? (
                  ...
                  <li
                    ...
                    className={`cursor-pointer px-4 py-3 hover:bg-slate-50 transition-colors ${!n.isRead ? 'bg-primary-50/40' : ''}`}
                  >
