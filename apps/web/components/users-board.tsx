        ...
        <FilterBar 
          ...
          actions={
            <div className="flex items-center gap-2">
              <select className="rounded-lg border-0 py-2 pl-3 pr-8 text-slate-900 shadow-sm ring-1 ring-inset ring-border-soft focus:ring-2 focus:ring-primary-600 sm:text-sm" value={roleFilter} onChange={e => setRoleFilter(e.target.value)}>
