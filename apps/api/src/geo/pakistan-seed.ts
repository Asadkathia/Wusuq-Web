...
const DISTRICT_CITY_HINTS = {
  'Punjab': {
    ...
    'Rawalpindi': ['Gujar Khan', 'Kahuta', 'Kallar Syedan', 'Kotli Sattian', 'Murree', 'Taxila'],
    'Sahiwal': ['Chichawatni'],
